...
public class AjaxController {
	...
	@ResponseBody // 리턴되는 값이 뷰가 아닌데이터이다.
	...
	public List<TestVO> ajaxList(){
		...
		lst.add(new TestVO(1, "홍길동", "010-1111-1111", "서울시 강남구 삼성동"));
		lst.add(new TestVO(2, "이순신", "010-2222-1111", "서울시 강남구 대치동"));
		lst.add(new TestVO(3, "세종대왕", "010-3333-1111", "서울시 강남구 역삼동"));
		lst.add(new TestVO(4, "김이나", "010-4444-1111", "서울시 강남구 논현동"));
	...
	public HashMap<String,TestVO> ajaxMap() {
		...
		map.put("m1", new TestVO(100, "이민호", "010-1111-9999", "송파구"));
		map.put("m2", new TestVO(200, "박서준", "010-2222-8888", "중구"));
		map.put("m3", new TestVO(300, "박보검", "010-3333-7777", "성북구"));
